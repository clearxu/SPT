...
class SegCLIP(EncoderDecoder):
    ...
    def __init__(self,
                ...
                #  init_cfg=None,
                 **args):
        super(SegCLIP, self).__init__(**args)
    ...
    def text_embedding(self, texts, img):
        text_embeddings = self.text_encoder(texts.to(img.device), self.class_names)
        text_embeddings = text_embeddings / text_embeddings.norm(dim=-1, keepdim=True)
        return text_embeddings
        
    def extract_feat(self, img, text_feat):
        """Extract features from images."""
        visual_feat = self.backbone(img, text_feat)
        # for fea in visual_feat:
        #     print(fea.shape)
        # exit(0)
        return visual_feat
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        visual_feat = self.extract_feat(img, text_feat)
        feat = []
    ...
    def slide_inference(self, img, img_meta, rescale):
        ...
        # print(preds.shape, crop_seg_logit.shape)
        # exit(0)
